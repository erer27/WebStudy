					...
					<div class="col-md-3">
						<div class="thumbnail">
							...
							<a href="detail.jsp?fno=${vo.fno }">
								<img src="https://www.menupan.com${vo.poster }" class="img-thumbnail" alt="Cinque Terre" width="304" height="236"> 
								<div class="caption">
									<p>${vo.name }</p>
								</div>
							</a>
					...
					%>
							<div class="col-md-2">
								<div class="thumbnail">
									상세보기 (한개) => 중복없이 적용된 데이터(Primary Key)
									<a href="#">
										<img src=<%=vo.getPoster() %> class="img-thumbnail" alt="Cinque Terre" width="120" height="120"> 
										<div class="caption">
