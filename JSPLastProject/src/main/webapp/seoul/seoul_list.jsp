                    ...
                    <div class="pagination-area d-sm-flex mt-15">
                        <nav aria-label="#">
                            <ul class="pagination">
                            	...
                            	<li class="page-item">
                                    <a class="page-link" href="../seoul/seoul_list.do?mode=${mode }&page=${startPage-1}"><i class="fa fa-angle-double-left" aria-hidden="true"> 이전</i></a>
                                </li>
                            	</c:if>
                                <c:forEach var="i" begin="${startPage }" end="${endPage }">
                                <li class="page-item ${i==curpage?'active':'' }">
                                    <a class="page-link" href="../seoul/seoul_list.do?mode=${mode }&page=${i } ">${i}<span class="sr-only"></span></a>
                                </li>
                                </c:forEach>
